...
/* GENERATOR SETTINGS
------------------------------------------------------- */
$settings['generator_name'] = $lang['generator_games_name'];
$settings['color_sheme']    = 'game';
$settings['wrapper_size']   = 'wrap-2';
$settings['head_icon']      = 'fa-gamepad';
...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $input['update']        = (!empty($_POST['update']) ? clean_input($_POST['update']) : '');
    $input['update_mini']   = (!empty($_POST['update']) ? clean_input($_POST['update']) : '');
...
------------------------------------------------------- */
    ...
    $validation = $site_template->parse_template("validation_games");
    ...
    $site_template->register_vars(array(
        ...
        "wrapper"                     => $settings['wrapper_size'],
        "head_icon"                   => $settings['head_icon'],
        "website_title"               => $lang['website_title_game'],
        ...
        "lang_update_tip"             => $lang['update_tip'],
    ...
    $site_template->print_template($site_template->parse_template("game"));
}
