...
/* GENERATOR SETTINGS
------------------------------------------------------- */
$settings['generator_name'] = $lang['generator_music_name'];
$settings['color_sheme']    = 'music';
$settings['wrapper_size']   = 'wrap-2';
$settings['head_icon']      = 'fa-music';
...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $input['quality']       = (!empty($_POST['quality']) ? clean_input($_POST['quality']) : '');
    $input['tracklist']     = (!empty($_POST['tracklist']) ? clean_input($_POST['tracklist']) : 'n/a');
    ...
    setcookie('ssbg_quality', clean_input($_POST['quality']), time() + (86400 * 30), "/");
    ...
    ------------------------------------------------------- */
    $tpl_bbcode = bbCode($input, $upl_tpl, $GLOBALS['bbCodeMusic']);
...
------------------------------------------------------- */
    ...
    $site_template->register_vars(array(
        ...
        "lang_error_quality"    => $lang['error_quality'],
        "lang_error_format"     => $lang['error_format'],
        "lang_error_tracklist"  => $lang['error_tracklist'],
        "lang_error_fileformat" => $lang['error_fileformat'],
    ));
    $validation = $site_template->parse_template("validation_music");
    ...
    $site_template->register_vars(array(
        ...
        "wrapper"                     => $settings['wrapper_size'],
        "head_icon"                   => $settings['head_icon'],
        "website_title"               => $lang['website_title_music'],
        ...
        "lang_tracklist"              => $lang['tracklist'],
        "lang_tracklist_tip"          => $lang['tracklist_tip'],
        "lang_size"                   => $lang['size'],
        ...
        "lang_follow"                 => $lang['follow'],
        "lang_donate"                 => $lang['donate'],
        "lang_quality"                => $lang['qualitiy'],
        "lang_format"                 => $lang['format'],
        "lang_format_tip"             => str_replace('{format}', 'MP3, WAV, OGG, ...', $lang['format_tip']),
        ...
        "cookie_quality"              => (isset($_COOKIE['ssbg_quality']) ? $_COOKIE['ssbg_quality'] : ''),
    ));
    $site_template->print_template($site_template->parse_template("music"));
}
