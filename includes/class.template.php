...
class Template
{
    ...
    public function print_template($template)
    {
        ...
        ------------------------------------------------------- */
        if (strpos($template, $this->start . 'header_index' . $this->end) !== false) {
            $header   = $this->parse_template("header_index");
            $template = str_replace($this->start . 'header_index' . $this->end, $header, $template);
        }

        if (strpos($template, $this->start . 'footer_index' . $this->end) !== false) {
            $footer   = $this->parse_template("footer_index");
            $template = str_replace($this->start . 'footer_index' . $this->end, $footer, $template);
        }
