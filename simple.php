...
/* GENERATOR SETTINGS
------------------------------------------------------- */
$settings['generator_name'] = $lang['generator_simple_name'];
$settings['color_sheme']    = 'simple';
$settings['wrapper_size']   = 'wrap-2';
$settings['head_icon']      = 'fa-hashtag';
...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    ------------------------------------------------------- */
    $tpl_bbcode = bbCode($input, $upl_tpl, $GLOBALS['bbCodeSimple']);
...
------------------------------------------------------- */
    ...
    $validation = $site_template->parse_template("validation_simple");
    ...
    $site_template->register_vars(array(
        ...
        "wrapper"                     => $settings['wrapper_size'],
        "head_icon"                   => $settings['head_icon'],
        "website_title"               => $lang['website_title_simple'],
    ...
    $site_template->print_template($site_template->parse_template("simple"));
}
